...
color03="b3/7c/5e" # Base 0F - Brown
...
color09="c8/64/28" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="a6/7a/50" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="d8/e2/dc" # Base 07 - Bright White
color236="4a/80/6c" # Base 01
color238="4a/8d/7e" # Base 02
color243="91/98/93" # Base 04
color253="c4/ce/c4" # Base 06
