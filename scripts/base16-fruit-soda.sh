...
color03="b1/6f/40" # Base 0F - Brown
...
color09="fe/6d/08" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f7/e2/03" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="2d/2c/2c" # Base 07 - Bright White
color236="e0/de/e0" # Base 01
color238="d8/d5/d5" # Base 02
color243="97/95/98" # Base 04
color253="47/45/45" # Base 06
