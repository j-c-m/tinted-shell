...
color03="bb/95/84" # Base 0F - Brown
...
color09="d2/8b/71" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f4/bc/87" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f5/ee/eb" # Base 07 - Bright White
color236="53/46/36" # Base 01
color238="64/52/40" # Base 02
color243="b8/af/ad" # Base 04
color253="e9/e1/dd" # Base 06
