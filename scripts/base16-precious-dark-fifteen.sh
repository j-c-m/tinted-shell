...
color09="e9/98/57" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="cf/a5/46" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ba/b9/b6" # Base 07 - Bright White
color236="30/33/37" # Base 01
color238="3e/40/44" # Base 02
color243="ab/aa/a8" # Base 04
color253="ba/b9/b6" # Base 06
