...
color03="cd/63/20" # Base 0F - Brown
...
color09="ea/77/0d" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="c9/d3/64" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="dd/df/e0" # Base 07 - Bright White
color236="1a/1b/1c" # Base 01
color238="28/29/2a" # Base 02
color243="a3/a5/a6" # Base 04
color253="cf/d1/d2" # Base 06
