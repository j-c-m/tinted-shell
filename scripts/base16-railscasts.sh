...
color03="bc/94/58" # Base 0F - Brown
...
color09="cc/78/33" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ff/c6/6d" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f9/f7/f3" # Base 07 - Bright White
color236="27/29/35" # Base 01
color238="3a/40/55" # Base 02
color243="d4/cf/c9" # Base 04
color253="f4/f1/ed" # Base 06
