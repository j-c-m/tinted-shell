...
color03="b4/d9/7c" # Base 0F - Brown
...
color09="ff/77/3a" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ff/d1/5e" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/f8/e1" # Base 07 - Bright White
color236="20/20/30" # Base 01
color238="2a/2a/3f" # Base 02
color243="51/51/55" # Base 04
color253="ff/f2/d1" # Base 06
