...
color03="df/20/6c" # Base 0F - Brown
...
color09="00/ff/66" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="20/df/6c" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f7/f3/f7" # Base 07 - Bright White
color236="1b/18/1b" # Base 01
color238="1d/1b/1d" # Base 02
color243="e7/db/db" # Base 04
color253="ff/ff/ff" # Base 06
