...
color03="82/57/57" # Base 0F - Brown
...
color09="82/82/57" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="6d/82/57" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="db/d6/d1" # Base 07 - Bright White
color236="2c/26/20" # Base 01
color238="43/3b/32" # Base 02
color243="8a/80/75" # Base 04
color253="be/b6/ae" # Base 06
