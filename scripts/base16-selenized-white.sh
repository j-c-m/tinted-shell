...
color03="dd/0f/9d" # Base 0F - Brown
...
color09="ba/37/00" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="af/85/00" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="28/28/28" # Base 07 - Bright White
color236="eb/eb/eb" # Base 01
color238="cd/cd/cd" # Base 02
color243="87/87/87" # Base 04
