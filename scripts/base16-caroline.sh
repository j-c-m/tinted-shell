...
color03="89/3f/45" # Base 0F - Brown
...
color09="a6/36/50" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f2/81/71" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="e3/a6/8c" # Base 07 - Bright White
color236="3a/24/25" # Base 01
color238="56/38/37" # Base 02
color243="8b/5d/57" # Base 04
color253="c5/8d/7b" # Base 06
