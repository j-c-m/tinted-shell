...
color03="b3/68/4f" # Base 0F - Brown
...
color09="ff/c3/87" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ff/94/70" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color236="22/27/3d" # Base 01
color238="52/58/66" # Base 02
color243="c8/c8/c8" # Base 04
