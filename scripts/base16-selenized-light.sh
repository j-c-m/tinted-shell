...
color03="c4/43/92" # Base 0F - Brown
...
color09="bc/58/19" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="a7/83/00" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="3a/4d/53" # Base 07 - Bright White
color236="ec/e3/cc" # Base 01
color238="d5/cd/b6" # Base 02
color243="90/99/95" # Base 04
color253="3a/4d/53" # Base 06
