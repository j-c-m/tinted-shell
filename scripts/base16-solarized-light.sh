...
color03="d3/36/82" # Base 0F - Brown
...
color09="cb/4b/16" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="b5/89/00" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="00/2b/36" # Base 07 - Bright White
color236="ee/e8/d5" # Base 01
color238="93/a1/a1" # Base 02
color243="65/7b/83" # Base 04
color253="07/36/42" # Base 06
