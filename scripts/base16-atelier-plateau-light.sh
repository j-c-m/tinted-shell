...
color03="bd/51/87" # Base 0F - Brown
...
color09="b4/5a/3c" # Base 09 - (Orange) Bright Red
...
color236="e7/df/df" # Base 01
color238="8a/85/85" # Base 02
color243="65/5d/5d" # Base 04
color253="29/24/24" # Base 06
