...
color03="bb/64/a9" # Base 0F - Brown
...
color09="ff/99/66" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ff/ff/66" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color236="3d/56/6f" # Base 01
color238="4b/69/88" # Base 02
color243="7e/90/a3" # Base 04
color253="d6/d7/d9" # Base 06
