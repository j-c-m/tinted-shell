...
color03="f2/9e/74" # Base 0F - Brown
...
color09="ff/ad/66" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ff/d1/73" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f3/f4/f5" # Base 07 - Bright White
color236="1f/24/30" # Base 01
color238="24/29/36" # Base 02
color243="8a/91/99" # Base 04
color253="d9/d7/ce" # Base 06
