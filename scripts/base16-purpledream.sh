...
color03="6a/2a/3c" # Base 0F - Brown
...
color09="cc/ae/14" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f0/00/a0" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/f0/ff" # Base 07 - Bright White
color236="30/20/30" # Base 01
color238="40/30/40" # Base 02
color243="bb/b0/bb" # Base 04
color253="ee/e0/ee" # Base 06
