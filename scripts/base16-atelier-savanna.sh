...
color03="86/74/69" # Base 0F - Brown
...
color09="9f/71/3c" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="a0/7e/3b" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ec/f4/ee" # Base 07 - Bright White
color236="23/2a/25" # Base 01
color238="52/60/57" # Base 02
color243="78/87/7d" # Base 04
color253="df/e7/e2" # Base 06
