...
color03="e3/48/8e" # Base 0F - Brown
...
color09="df/59/23" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="bb/88/01" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="e7/e2/d9" # Base 07 - Bright White
color236="18/1c/22" # Base 01
color238="22/26/2d" # Base 02
color243="94/90/88" # Base 04
color253="ca/c6/bd" # Base 06
