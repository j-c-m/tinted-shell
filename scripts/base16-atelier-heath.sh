...
color03="cc/33/cc" # Base 0F - Brown
...
color09="a6/59/26" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="bb/8a/35" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f7/f3/f7" # Base 07 - Bright White
color236="29/23/29" # Base 01
color238="69/5d/69" # Base 02
color243="9e/8f/9e" # Base 04
color253="d8/ca/d8" # Base 06
