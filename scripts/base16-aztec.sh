...
color03="a9/28/b9" # Base 0F - Brown
...
color09="ee/88/00" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ee/bb/00" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/eb/a0" # Base 07 - Bright White
color236="1a/1e/01" # Base 01
color238="24/26/04" # Base 02
color243="ff/d1/29" # Base 04
color253="ff/e1/78" # Base 06
