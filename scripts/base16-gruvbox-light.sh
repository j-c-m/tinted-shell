...
color03="9d/00/06" # Base 0F - Brown
...
color09="d6/5d/0e" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="d7/99/21" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="1d/20/21" # Base 07 - Bright White
color236="eb/db/b2" # Base 01
color238="d5/c4/a1" # Base 02
color243="7c/6f/64" # Base 04
