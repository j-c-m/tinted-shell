...
color03="5f/87/87" # Base 0F - Brown
...
color09="5f/af/5f" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="af/d7/00" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="d0/d0/d0" # Base 07 - Bright White
color236="af/00/5f" # Base 01
color238="5f/af/00" # Base 02
color243="5f/af/d7" # Base 04
color253="d7/87/5f" # Base 06
