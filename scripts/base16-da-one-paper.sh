...
color09="ff/94/70" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="b3/68/4f" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="00/00/00" # Base 07 - Bright White
color236="c8/c8/c8" # Base 01
color238="88/88/88" # Base 02
color243="28/28/28" # Base 04
color253="00/00/00" # Base 06
