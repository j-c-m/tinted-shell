...
color03="b0/71/58" # Base 0F - Brown
...
color09="bd/69/42" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ce/94/3e" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="24/1c/19" # Base 07 - Bright White
color236="df/d6/d1" # Base 01
color238="d0/c1/bb" # Base 02
color243="59/45/3d" # Base 04
color253="35/2a/25" # Base 06
