...
export TINTED_THEME="base24-builtin-light"

if [ "base24" = "base16" ]; then
  export BASE16_THEME="builtin-light"
fi
...
export TINTED_COLOR_BRIGHT09_RGB="8c8c00"
...
export TINTED_COLOR_BRIGHT0F_RGB="460000"
