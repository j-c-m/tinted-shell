...
color03="d4/35/52" # Base 0F - Brown
...
color09="b6/56/11" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ae/95/13" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="fe/fb/ec" # Base 07 - Bright White
color236="29/28/24" # Base 01
color238="6e/6b/5e" # Base 02
color243="99/95/80" # Base 04
color253="e8/e4/cf" # Base 06
