...
color03="bc/73/a4" # Base 0F - Brown
...
color09="ba/82/3a" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="8d/97/41" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/fd/fb" # Base 07 - Bright White
color236="30/33/38" # Base 01
color238="3e/40/44" # Base 02
color243="8f/8f/8f" # Base 04
color253="ff/f7/ed" # Base 06
