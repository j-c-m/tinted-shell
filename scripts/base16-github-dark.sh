...
color03="3d/2f/00" # Base 0F - Brown
...
color09="db/6d/28" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="bb/80/09" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color236="30/36/3d" # Base 01
color238="48/4f/58" # Base 02
color243="8b/94/9e" # Base 04
color253="f0/f6/fc" # Base 06
