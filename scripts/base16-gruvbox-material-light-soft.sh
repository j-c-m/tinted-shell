...
color03="e7/8a/4e" # Base 0F - Brown
...
color09="c3/5e/0a" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="b4/71/09" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="28/28/28" # Base 07 - Bright White
color236="eb/db/b2" # Base 01
color238="c9/b9/9a" # Base 02
color243="66/5c/54" # Base 04
color253="3c/38/36" # Base 06
