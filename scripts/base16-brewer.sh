...
color03="b1/59/28" # Base 0F - Brown
...
color09="e6/55/0d" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="dc/a0/60" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="fc/fd/fe" # Base 07 - Bright White
color236="2e/2f/30" # Base 01
color238="51/52/53" # Base 02
color243="95/96/97" # Base 04
color253="da/db/dc" # Base 06
