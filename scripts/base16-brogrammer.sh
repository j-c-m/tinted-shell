...
color03="ff/ff/ff" # Base 0F - Brown
...
color09="de/35/2e" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="1d/d3/61" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="d6/db/e5" # Base 07 - Bright White
color236="f8/11/18" # Base 01
color238="2d/c5/5e" # Base 02
color243="2a/84/d2" # Base 04
color253="10/81/d6" # Base 06
