...
color03="50/9c/93" # Base 0F - Brown
...
color09="db/70/70" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="d6/98/22" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="5e/64/6f" # Base 07 - Bright White
color236="7c/9f/4b" # Base 01
color238="d6/98/22" # Base 02
color243="65/87/bf" # Base 04
color253="b8/70/ce" # Base 06
