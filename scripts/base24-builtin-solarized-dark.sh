...
export TINTED_THEME="base24-builtin-solarized-dark"

if [ "base24" = "base16" ]; then
  export BASE16_THEME="builtin-solarized-dark"
fi
...
export TINTED_COLOR_BRIGHT09_RGB="ffc308"
...
export TINTED_COLOR_BRIGHT0F_RGB="bc2b27"
