...
color03="d2/7b/53" # Base 0F - Brown
...
color09="e6/db/74" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="fd/b1/1f" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="e1/ea/ef" # Base 07 - Bright White
color236="25/2c/2d" # Base 01
color238="37/3c/3d" # Base 02
color243="81/8f/80" # Base 04
color253="e3/e3/c8" # Base 06
