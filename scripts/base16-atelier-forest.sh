...
color03="c3/3f/f3" # Base 0F - Brown
...
color09="df/53/20" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="c3/84/18" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f1/ef/ee" # Base 07 - Bright White
color236="2c/24/21" # Base 01
color238="68/61/5e" # Base 02
color243="9c/94/91" # Base 04
color253="e6/e2/e0" # Base 06
