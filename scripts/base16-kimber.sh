...
color03="70/4f/4f" # Base 0F - Brown
...
color09="47/6c/88" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="d8/b5/6d" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/ff/e6" # Base 07 - Bright White
color236="31/31/31" # Base 01
color238="55/5d/55" # Base 02
color243="5a/5a/5a" # Base 04
color253="c3/c3/b4" # Base 06
