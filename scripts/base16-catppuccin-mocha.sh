...
color03="f2/cd/cd" # Base 0F - Brown
...
color09="fa/b3/87" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f9/e2/af" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="b4/be/fe" # Base 07 - Bright White
color236="18/18/25" # Base 01
color238="31/32/44" # Base 02
color243="58/5b/70" # Base 04
color253="f5/e0/dc" # Base 06
