...
export TINTED_THEME="base24-builtin-tango-dark"

if [ "base24" = "base16" ]; then
  export BASE16_THEME="builtin-tango-dark"
fi
...
export TINTED_COLOR_BRIGHT09_RGB="ffd414"
...
export TINTED_COLOR_BRIGHT0F_RGB="cc0000"
