...
color03="f0/03/ef" # Base 0F - Brown
...
color09="fc/8d/28" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="f3/e8/77" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="f5/f5/ff" # Base 07 - Bright White
color236="20/20/4a" # Base 01
color238="30/30/5a" # Base 02
color243="b0/b0/da" # Base 04
color253="e0/e0/ff" # Base 06
