...
color03="56/52/6e" # Base 0F - Brown
...
color09="f6/c1/77" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ea/9a/97" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="56/52/6e" # Base 07 - Bright White
color236="2a/27/3f" # Base 01
color238="39/35/52" # Base 02
color243="90/8c/aa" # Base 04
color253="e0/de/f4" # Base 06
