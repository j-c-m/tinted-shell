...
color03="e9/6b/a8" # Base 0F - Brown
...
color09="f9/9b/15" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="fe/c4/18" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="e7/e9/db" # Base 07 - Bright White
color236="41/32/3f" # Base 01
color238="4f/42/4c" # Base 02
color243="8d/86/87" # Base 04
color253="b9/b6/b0" # Base 06
