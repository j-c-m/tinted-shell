...
color03="8a/55/3f" # Base 0F - Brown
...
color09="db/7b/55" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="e6/cd/69" # Base 0A - Bright Yellow
color12="$color04" # Base 0D - Bright Blue
color13="$color05" # Base 0E - Bright Magenta
color14="$color06" # Base 0C - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color236="28/2a/2b" # Base 01
color238="3b/75/8c" # Base 02
color243="43/a5/d5" # Base 04
color253="ee/ee/ee" # Base 06
