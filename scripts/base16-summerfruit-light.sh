...
color03="cc/66/33" # Base 0F - Brown
...
color09="fd/89/00" # Base 09 - (Orange) Bright Red
color10="$color02" # Base 0B - Bright Green
color11="ab/a8/00" # Base 0A - Bright Yellow
...
color243="00/00/00" # Base 04
color253="15/15/15" # Base 06
